...
public class Savings extends Account {
   ...
   public static int RetrieveAccountBalance(String accNum, Customer [] 
        ...
        */
        ...
        while(loc < numOfCustomers && !accNum.equals(aCustomer[loc].GetSavingsAccountNumber())){
            loc++;
        }
        if(accNum.equals(aCustomer[loc].GetSavingsAccountNumber())){
            System.out.printf("\nThe account of " + aCustomer[loc].GetFirstName()
                               +" "  +aCustomer[loc].GetLastName() 
                               +" was accessed\n");            
            System.out.printf("The savings balance is $" + aCustomer[loc].GetSavingsBalance());
            ...
            System.out.println("The balance couldn't be accessed. Check the account number.");
        }
        return loc;
    }
    @Override
    ...
    public static int RetrieveBalanceDeposit(int accNum, double depositAmount, 
        ...
        while(loc < numOfCustomers && accNum != Double.parseDouble(aCustomer[loc].GetSavingsAccountNumber())){
            loc++;
        }               
    ...
    public static void Deposit(Customer [] aCustomer, int numOfCustomers, 
        ...
        double newBalance;
        //System.out.println("Loc & NOC"+loc+" "+numOfCustomers);
        
        if (loc < numOfCustomers) {
            
            newBalance = Double.parseDouble(aCustomer[loc].GetSavingsBalance()) + depositAmount;
            System.out.printf("\nThe account of " + aCustomer[loc].GetFirstName()
                              + " "  +aCustomer[loc].GetLastName() +
                              " was accessed\n");
            System.out.print("Old Balance $"+ aCustomer[loc].GetSavingsBalance()
                              + "\n");
...
//        Save(aCustomer,numOfCustomers);
    ...
    public static void RetrieveBalanceWithdrawal(int accNum, double withdrawalAmount, 
                                             Customer [] aCustomer,
                                             int numOfCustomers, FileWriter fw)
                                             throws IOException{
        ...
        while(loc < numOfCustomers && accNum != Double.parseDouble(aCustomer[loc].GetCreditAccountNumber())){
        ...
        if (accNum == Double.parseDouble(aCustomer[loc].GetCreditAccountNumber())) {

            newBalance = Double.parseDouble(aCustomer[loc].GetCreditBalance()) - withdrawalAmount;
            System.out.printf("\nThe account of " + aCustomer[loc].GetFirstName()
                    + " " + aCustomer[loc].GetLastName()
                    + " was accessed\n");
            System.out.print("Old Balance $" + aCustomer[loc].GetCheckingBalance()
                    + "\n");
            aCustomer[loc] = new Customer(aCustomer[loc].firstName,
                    aCustomer[loc].lastName,
                    aCustomer[loc].dateOfBirth,
    ...
    public static void ProcessTransfer(String accSourceNum, String accDestNum,
        ...
        if (accSourceNum.charAt(3) == accDestNum.charAt(3)) {
            ...
            while (loc < numOfCustomers && accSourceNum.equals(aCustomer[loc].GetSavingsAccountNumber())) {
                loc++;
            }
            switch (accDest) {
                case 1:
                    TransferToChecking(aCustomer, numOfCustomers, loc,
    ...
    public static void TransferToCredit(Customer[] aCustomer,
        ...
        if (Double.parseDouble(aCustomer[loc].GetSavingsBalance()) == 0) {
            System.out.print("You don't have any money in your savings account");

        } else if (accSourceNum.equals(
                aCustomer[loc].GetCheckingAccountNumber())) {

            newBalance1 = Double.parseDouble(aCustomer[loc].GetSavingsBalance())
                    - transferAmount;
            ...
            System.out.print("The amount of  $" + transferAmount + "was "
                    + "transfered from their savings account to their credit account"
                    + "\n");
            aCustomer[loc] = new Customer(aCustomer[loc].firstName,
                    aCustomer[loc].lastName,
                    aCustomer[loc].dateOfBirth,
    ...
    public static void TransferToChecking(Customer[] aCustomer,
            int numOfCustomers, int loc,
            String accDestNum,
            double transferAmount,
            String accSourceNum,
        ...
        if (Double.parseDouble(aCustomer[loc2].GetSavingsBalance()) == 0) {
            System.out.print("You don't have any money in your savings account");

        } else if (accSourceNum.equals(
                aCustomer[loc2].GetSavingsAccountNumber())) {

            newBalance1 = Double.parseDouble(aCustomer[loc2].GetSavingsBalance())
                    - transferAmount;
            ...
            System.out.printf("\nThe account of "
                    ...
                    + " was accessed\n");
            System.out.print("The amount of  $" + transferAmount + " was "
                    + "transfered from their savings account to their checking account"
                    + "\n");
    ...
    public static int payerRetrieval(String payerAccNum,Customer [] aCustomer,
        ...
        while (loc1 < numOfCustomers
                && !payerAccNum.equals(aCustomer[loc1].GetSavingsAccountNumber())) {
    ...
    public static void AmountPaidChecking(String payerAccNum, String payeeAccNum, 
        ...
        */
        ...
        if (Double.parseDouble(aCustomer[loc1].GetSavingsBalance()) > 0){
            if (payerAccNum.equals(aCustomer[loc1].GetSavingsAccountNumber())){
                newBalancePayer = Double.parseDouble(aCustomer[loc1].GetSavingsBalance()) - amountPaid;
